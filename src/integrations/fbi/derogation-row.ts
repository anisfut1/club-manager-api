import type { FbiDerogationRow } from "./types.js";
 ...
 * un intitulé deviné qui ne viendrait pas d'une capture réelle.
 */
const HEADER_ALIASES: Record<Exclude<keyof FbiDerogationRow, "raw">, string[]> = {
